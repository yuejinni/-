...
TABLES: dict[str, TableDef] = {
    ...
    "sales_order_requests": TableDef(
        "sales_order_requests",
        [
            ("account", "NVARCHAR(100) NOT NULL"),
            ("number", "NVARCHAR(100) NOT NULL"),
            ("internal_id", "NVARCHAR(100) NULL"),
            ("date", "NVARCHAR(32) NULL"),
            ("customer_name", "NVARCHAR(255) NULL"),
            ("total_qty", "FLOAT NOT NULL DEFAULT 0"),
            ("total_amount", "FLOAT NOT NULL DEFAULT 0"),
            ...
            ("sync_status", "NVARCHAR(100) NULL"),
            ("data_json", "NVARCHAR(MAX) NOT NULL"),
            ("updated_at", "NVARCHAR(32) NOT NULL"),
        ],
        ("account", "number"),
        [
            _idx("idx_sales_order_requests_date", ["date"]),
            _idx("idx_sales_order_requests_customer", ["customer_name"]),
            _idx("idx_sales_order_requests_internal", ["account", "internal_id"]),
        ],
    ),
    "sales_order_request_details": TableDef(
        ...
        ("account", "number"),
        [_idx("idx_sales_order_request_details_internal", ["account", "internal_id"])],
    ),
